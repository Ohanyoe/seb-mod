...
@Mod("seb_mod_")
public class SebModMod {
	public static final Logger LOGGER = LogManager.getLogger(SebModMod.class);
	public static final String MODID = "seb_mod_";
